...
public class ParameterList(TagService tagService)
{
	...
	public UsGlobalSpaceConfig UsGlobalSpaceConfig { get; set; } = new();

	[JsonPropertyName("us-sdkClientFeaturesSwitches")]
	public UsSdkClientFeaturesSwitches UsSdkClientFeaturesSwitches { get; set; } = new();

	[JsonPropertyName("us-sdkClientMocks")]
	public UsSdkClientMocks? UsSdkClientMocks { get; set; }

	[JsonPropertyName("us-sdkClientNotificationsGame")]
	public UsSdkClientNotificationsGame UsSdkClientNotificationsGame { get; set; } = new();

	[JsonPropertyName("us-sdkClientNotificationsInternal")]
	public UsSdkClientNotificationsInternal UsSdkClientNotificationsInternal { get; set; } = new();

	[JsonPropertyName("us-sdkClientNotificationsSpaceIds")]
	public UsSdkClientNotificationsSpaceIds UsSdkClientNotificationsSpaceIds { get; set; } = new();

	[JsonPropertyName("us-sdkClientRemoteLogsGame")]
	public UsSdkClientRemoteLogsGame UsSdkClientRemoteLogsGame { get; set; } = new();

	[JsonPropertyName("us-sdkClientRemoteLogsInternal")]
	public UsSdkClientRemoteLogsInternal UsSdkClientRemoteLogsInternal { get; set; } = new();

	[JsonPropertyName("us-sdkClientSettings")]
	public UsSdkClientSettings UsSdkClientSettings { get; set; } = new();

	[JsonPropertyName("us-sdkClientSettingsCacheTTL")]
	public UsSdkClientSettingsCacheTtl UsSdkClientSettingsCacheTtl { get; set; } = new();

	[JsonPropertyName("us-sdkClientSettingsHttpGame")]
	public UsSdkClientSettingsHttpGame UsSdkClientSettingsHttpGame { get; set; } = new();

	[JsonPropertyName("us-sdkClientSettingsHttpInternal")]
	public UsSdkClientSettingsHttpInternal UsSdkClientSettingsHttpInternal { get; set; } = new();

	[JsonPropertyName("us-sdkClientSettingsSecondaryStoreSync")]
	public UsSdkClientSettingsSecondaryStoreSync UsSdkClientSettingsSecondaryStoreSync { get; set; } = new();

	[JsonPropertyName("us-sdkClientSettingsWebSocketGame")]
	public UsSdkClientSettingsWebSocketGame UsSdkClientSettingsWebSocketGame { get; set; } = new();

	[JsonPropertyName("us-sdkClientSettingsWebSocketInternal")]
	public UsSdkClientSettingsWebSocketInternal UsSdkClientSettingsWebSocketInternal { get; set; } = new();

	[JsonPropertyName("us-sdkClientStorm")]
	public UsSdkClientStorm UsSdkClientStorm { get; set; } = new();

	[JsonPropertyName("us-sdkClientUrls")]
	public UsSdkClientUrls UsSdkClientUrls { get; set; } = new();

	[JsonPropertyName("us-simulation")]
	public UsSimulation UsSimulation { get; set; } = new();

	[JsonPropertyName("ActivityPage")]
	public ActivityPage ActivityPage { get; set; } = new();
	public CustomClientFeaturesSwitches CustomClientFeaturesSwitches { get; set; } = new();

	[JsonPropertyName("FirstPartyBundles")]
	public FirstPartyBundles FirstPartyBundles { get; set; } = new();

	[JsonPropertyName("FirstPartySubscriptions")]
	public FirstPartySubscriptions FirstPartySubscriptions { get; set; } = new();
	...
	public Mcaversion Mcaversion { get; set; } = new();

	[JsonPropertyName("Multiplayer")]
	public Multiplayer Multiplayer { get; set; } = new();

	[JsonPropertyName("Onboarding")]
	public Onboarding Onboarding { get; set; } = new();

	[JsonPropertyName("recommendations_activitypage")]
	public RecommendationsActivitypage RecommendationsActivitypage { get; set; } = new();

	[JsonPropertyName("recommendations_nextsteps")]
	public RecommendationsNextsteps RecommendationsNextsteps { get; set; } = new();

	[JsonPropertyName("ServerInfo")]
	public ServerInfo ServerInfo { get; set; } = new();

	[JsonPropertyName("ServerSSLInfo")]
	public ServerSslInfo ServerSslInfo { get; set; } = new();

	[JsonPropertyName("ShopV1DisplayConfig")]
	public ShopV1DisplayConfig ShopV1DisplayConfig { get; set; } = new();

	[JsonPropertyName("SongsLibrary")]
	public SongsLibrary SongsLibrary { get; set; } = new(tagService);

	[JsonPropertyName("Tracking")]
	public Tracking Tracking { get; set; } = new();

	[JsonPropertyName("UbiConnect")]
	public UbiConnect UbiConnect { get; set; } = new();
}

public class UsGlobalSpaceConfig
{
	public Dictionary<string, Guid> Fields { get; set; } = new()
	{
...
public class UsSdkClientFeaturesSwitches
{
	public Dictionary<string, bool> Fields { get; set; } = new()
	{
		// Is it just me or does this look like half a Christmas tree?
		{"ugc", true},
		{"news", true},
		{"tlog", true},
		{"event", true},
	...
	public RelatedPopulation? RelatedPopulation { get; set; } = new()
	{
		Name = "Switch",
		Subject = "Platform"
	};
...
public class UsSdkClientMocks
{
	public Dictionary<string, string> Fields { get; set; } = [];
	public RelatedPopulation? RelatedPopulation { get; set; }
}

public class UsSdkClientNotificationsGame
{
...
public class UsSdkClientNotificationsInternal
{
	public Dictionary<string, bool> Fields { get; set; } = new()
	{
		{"BLOCKLIST_ADD", true},
...
public class UsSdkClientNotificationsSpaceIds
{
	public Dictionary<string, Guid> Fields { get; set; } = new()
	{
...
public class UsSdkClientRemoteLogsGame
{
	public Dictionary<string, object> Fields { get; set; } = new()
	{
		{"url", ""},
...
public class UsSdkClientRemoteLogsInternal
{
	public Dictionary<string, object> Fields { get; set; } = new()
	{
		{"job", "Error"},
...
public class UsSdkClientSettings
{
	public Dictionary<string, object> Fields { get; set; } = new()
	{
...
public class UsSdkClientSettingsCacheTtl
{
...
public class UsSdkClientSettingsHttpGame
{
	public Dictionary<string, int> Fields { get; set; } = new()
	{
		{"maxCount", 3},
...
public class UsSdkClientSettingsHttpInternal
{
	public Dictionary<string, int> Fields { get; set; } = new()
	{
		{"maxCount", 3},
...
public class UsSdkClientSettingsSecondaryStoreSync
{
	public Dictionary<string, int> Fields { get; set; } = new()
	{
		{"maxCount", 10},
...
public class UsSdkClientSettingsWebSocketGame
{
	public Dictionary<string, int> Fields { get; set; } = new()
	{
		{"maxCount", 50},
...
public class UsSdkClientSettingsWebSocketInternal
{
	public Dictionary<string, int> Fields { get; set; } = new()
	{
		{"maxCount", 50},
...
{
	public Dictionary<string, Template> Fields { get; set; } = new()
	{
...
public class Template
{
	...
	[
		new TemplateItem { Itemtype = "song", Categorytype = "carousel" },
		new TemplateItem { Itemtype = "playlist", Categorytype = "carousel" },
		new TemplateItem { Categorytype = "banner" },
		new TemplateItem { Itemtype = "song", Categorytype = "carousel" },
		new TemplateItem { Itemtype = "playlist", Categorytype = "carousel" },
		new TemplateItem { Itemtype = "song", Categorytype = "carousel" },
		new TemplateItem { Categorytype = "banner" },
...
public class CustomClientFeaturesSwitches
{
	public Dictionary<string, bool> Fields { get; set; } = new()
	{
		{"CameraScoring", true},
...
public class FirstPartyBundles
{
	public Dictionary<string, Dictionary<string, Bundle>> Fields { get; set; } = [];
	public RelatedPopulation? RelatedPopulation { get; set; }
}
...
public class Bundle
{
	...
	public int ProductPriorityWithinGroup { get; set; }
}

public class FirstPartySubscriptions
{
	public Dictionary<string, Dictionary<string, Subscription>> Fields { get; set; } = [];
	public RelatedPopulation? RelatedPopulation { get; set; }
}
...
public class GameplaySettings
{
	public Dictionary<string, object> Fields { get; set; } = new()
	{
		// Todo: update claim priority with a packService?
...
public class RecommendationsActivitypage
{
	public Dictionary<string, object> Fields { get; set; } = new()
	{
...
public class RecommendationsNextsteps
{
	public Dictionary<string, string> Fields { get; set; } = new()
	{
		{"AlgoType", "rss"},
...
public class ServerSslInfoFields
{
	public PublicKeyPinning PublicKeyPinning { get; set; } = new();
}
...
public class ShopV1DisplayConfig
{
	public Dictionary<string, ShopV1DisplayConfigFields> Fields { get; set; } = [];
	public RelatedPopulation? RelatedPopulation { get; set; }
}

public class ShopV1DisplayConfigFields
{
	public List<string> BundleProductIds { get; set; } = [];
	public List<string> BundleProductShopIds { get; set; } = [];
	public List<string> SubscriptionProductIds { get; set; } = [];
	public List<string> SubscriptionProductShopIds { get; set; } = [];
}

public class SongsLibrary(TagService tagService)
{
	public Dictionary<string, Filters> Fields { get; set; } = new()
	{
